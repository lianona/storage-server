...
# The source files.
SRCS = server.c storage.c utils.c client.c encrypt_passwd.c data.c lex.yy.c
...
$(CLIENTLIB): storage.o utils.o data.o
	$(AR) rcs $@ $^

server: server.c server.h lex.yy.c
	cc server.c -g -lpthread utils.c -lcrypt data.c lex.yy.c -ll -o server 
